<?php
    ...
    $vTecnomecanica = htmlspecialchars($_GET['vTecnomecanica'],ENT_QUOTES,'UTF-8');
    $tarifas = $TA->listar_tarifa();
    $consulta = $MT->exportarTarjeton($dueno,$conductor,$placa,$nInterno,$nMovilizacion,$vLicencia,$vMovilizacion,$vSoat,$eps,$rh,$arl,$fondoPension,$entResp,$nit,$id,$tarifas,$control,$ext,$dir,$tele,$vTecnomecanica);
